...
import { useActions, useDevice } from '@/hooks';
import { useSelector } from 'react-redux';
import { RootState } from '@/store';

export const ModalBarLink = (props: any) => {
	const { modalOpen } = useSelector((state: RootState) => state.base);
	const { CLOSE_MODAL } = useActions()
	const { Title, Text, Button, LinkText, Tag, Icon } = useUI();
